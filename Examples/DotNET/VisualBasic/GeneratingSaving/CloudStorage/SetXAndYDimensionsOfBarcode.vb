...
Namespace GeneratingSaving.CloudStorage
    ...
    Class SetXAndYDimensionsOfBarcode
        ...
        Public Shared Sub Run()
            ...
            Dim resolutionX As System.Nullable(Of Single) = 1.0F
            Dim resolutionY As System.Nullable(Of Single) = 0.0F

            ' Set Width and Height of barcode unit
            Dim dimensionX As System.Nullable(Of Single) = 1.0F
            Dim dimensionY As System.Nullable(Of Single) = 0.5F
            ...
            Dim enableChecksum As [String] = "Yes"
            ...
            Try
                ...
                ' Invoke Aspose.BarCode Cloud SDK API to generate image with specific X and Y dimensions of a barcode
