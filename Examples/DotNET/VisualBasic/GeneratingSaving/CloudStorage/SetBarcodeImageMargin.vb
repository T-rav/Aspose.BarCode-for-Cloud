...
Namespace GeneratingSaving.CloudStorage
    ...
    Class SetBarcodeImageMargin
        ...
        Public Shared Sub Run()
            ...
            Dim topMargin As System.Nullable(Of Single) = 2.0F
            Dim bottomMargin As System.Nullable(Of Single) = 2.0F
            Dim leftMargin As System.Nullable(Of Single) = 2.0F
            Dim rightMargin As System.Nullable(Of Single) = 2.0F
