...
class GenerateBarcode {
	...
	public function specifyCodetextAndSymbologyForBarcode() {
		...
		// invoke Aspose.BarCode Cloud SDK API to generate image with specify code text and symbology for barcode
...
$generateBarcode->specifyCodetextAndSymbologyForBarcode();
