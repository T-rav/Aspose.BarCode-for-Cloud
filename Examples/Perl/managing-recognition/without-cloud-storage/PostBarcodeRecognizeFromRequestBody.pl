...
# Barcode type
my $type = 'Code39Standard';
# Set the encoded base64 image data
my $body = 'iVBORw0KGgoAAAANSUhEUgAAAH0AAABOCAYAAAANbhkmAAAAAXNSR0IArs4c6QAAAARnQU1BAACx
...
# Invoke Aspose.BarCode Cloud SDK API to read barcode from request body                                   
my $response = $barcodeApi->PostBarcodeRecognizeFromRequestBody(type => $type, body => $body);
